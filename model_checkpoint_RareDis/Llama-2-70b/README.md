...
This checkpoint is intended for research use only. It should not be used as a standalone clinical phenotyping system or as a substitute for medical expertise.

Because this checkpoint was fine-tuned only on the RareDis corpus, its behavior and performance may differ from the actual RARE-PHENIX model described in the paper
